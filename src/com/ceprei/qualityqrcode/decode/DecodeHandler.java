package com.ceprei.qualityqrcode.decode;
...
import com.ceprei.qualityqrcode.activity.CaptureActivity;
import com.ceprei.qualityqrcode.R;
import com.ceprei.qualityqrcode.bitmap.PlanarYUVLuminanceSource;
		...
		if (result != null) {
			...
			if (null != activity.getHandler()) {
				...
				try {
					...
					int compId = Integer.parseInt(json.getString("compId"));
					String batchNum = json.getString("batchNum");
					String prodDate = json.getString("prodDate");
					activity.openProductActivity(compId,batchNum,prodDate);
