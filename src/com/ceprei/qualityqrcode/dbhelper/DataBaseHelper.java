package com.ceprei.qualityqrcode.dbhelper;
import java.io.File;
...
public class DataBaseHelper extends SQLiteOpenHelper {
   ...
   //数据库文件目标存放路径为系统默认位置，com.ceprei.qualityqrcode.dbhelper 是你的包名
   @SuppressLint("SdCardPath") 
   private static String DB_PATH        = "/data/data/com.ceprei.qualityqrcode/databases/";
/*
   //如果你想把数据库文件存放在SD卡的话
...
*/
   ...
   private static String ASSETS_NAME     = "QR.db";
   ...
   **/
   ...
   //复制assets下的大数据库文件时用这个 原来为private的
